namespace StudentSystem.Migrations
{
    ...
    public partial class InitialCreate : DbMigration
    {
                ...
                c => new
                    {
                        ...
                        SubmmitionDate = c.DateTime(nullable: false),
                        Course_Id = c.Int(),
                        Student_Id = c.Int(),
                    })
                .PrimaryKey(t => t.Id)
        ...
        {
            DropForeignKey("dbo.Resoursces", "Course_Id", "dbo.Courses");
